...
\end{ex}
\todo{Add example on Boolean algebras}
%
...
Moreover,
it is convenient to make an additional assumption:
for every~$f\in\overline F \cap R$
there are $\varphi$-convergent sequences
 $\ell_1 \geq \ell_2 \geq \dotsb$
and $u_1 \leq u_2 \leq \dotsb$
such that $\bw_n \ell_n \leq f \leq \bv_n u_n$
(see \todo{Add reference to the discussion of this property
in the setting of $E$ with fitting uniformity}).
