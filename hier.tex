...
\end{equation*}
We will prove that~$D^\Pi_f \in \Sigma_{\alpha[f]}\mathcal{T}$
and $D^\Pi_f\notin \Pi_{\alpha[f]}\mathcal{T}$.

Let us prove $D^\Pi_f \in \Sigma_{\alpha[f]}\mathcal{T}$.
...
\Delta(g) \,\notin\, U^\Pi_f
\quad\iff\quad
g\,\in\,\Delta^*(\,\N^\N \backslash U^\Sigma_f \,).
\end{equation*}
So we see that $D^\Sigma_f = \Delta^*(\,\N^\N\backslash U_f^\Sigma\,)$.
We have already shown 
that~$U_f^\Sigma_f^\Sigma \in \Sigma_{\alpha[f]}\mathcal{T}$,
so it is easy to see (using 
