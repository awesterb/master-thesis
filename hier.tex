...
The proof of Statement~\eqref{eq:hierarchy-theorem}
we will give in this subsection
uses the rule of the excluded middle
...
Let us describe the topology on~$\N^\N$.
For this,
we need 
