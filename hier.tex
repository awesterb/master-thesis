...
\subsubsection{The Open Subsets of $\N^\N$}$\,$\\
...
\subsubsection{Encoding of Open Subsets of~$\N^\N$}$\,$\\
...
\subsubsection{Encoding of Countable Ordinal Numbers}$\,$\\
...
\subsubsection{Encoding of Borel Subsets of~$\N^\N$}$\,$\\
