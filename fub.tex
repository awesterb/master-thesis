...
\todo{add statement of Fubini's Theorem}
...
$\varphi$-convergence (see Definition~\todo{add reference})
...
is the proof of Fubuni's Theorem (see~\todo{add ref.}).
...
\end{proof}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo{Derive Fubini's Theorem from the above theorem.}
\end{document}
