...
%
\begin{dfn}
Let $P$ and $Q$ be partially ordered sets
and let $f\colon P\ra Q$ be a map.
...
from~$P$,
then $f(\bw_n a_n) = \bw_n f(a_n)$, and
...
\begin{thm}
Let $\vs{V}{L}{\varphi}{E}$,
 $\vs{W}{K}{\psi}{F}$ be valuation systems.
Let
$A\colon V\ra W$
and 
$f\colon E\ra F$ be $\sigma$-preserving maps,
such that $A(L)\subseteq K$
